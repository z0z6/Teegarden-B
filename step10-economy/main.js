...
import { createStarSystem, SYSTEMS, SYSTEM_ORDER } from '../shared/systems/star-systems.js';
...
window.addEventListener('keydown', (e) => {
  ...
  if (e.code === 'KeyM') mapEl.classList.toggle('visible');
});
...
if (!urlMission) comms.say({
  sender: 'Wolny lot', sub: 'krok 10', color: '#9fd8ff',
  text: matchMedia('(pointer: coarse)').matches
    ? 'Krok 10: przemysł. Pas planetoid jest po prawej. KOP — promień wydobywczy, panel na dole ekranu: rozładunek i przemysł (stacje, roje dronów).'
    : 'Krok 10: przemysł. Pas planetoid jest po prawej (etykiety stacji i złóż na ekranie). T — promień wydobywczy, Y — rozładunek w stacji, P — panel przemysłu: stacje i roje dronów. N — tablica misji.',
  ttl: 14,
});
