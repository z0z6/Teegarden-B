...
// FLOTA DO WYBORU
// ============================================================
// FLOTA: definicje statków (plik, nazwa, orientacja dziobu) siedzą we
// WSPÓLNYM pliku shared/ships/fleet.js - ten sam dla kroków 3 i 4, żeby
// poprawka orientacji/kadrowania jednego statku nie musiała być
// powielana ręcznie w każdym kroku.
//
...
async function loadShip(index) {
  ...
  // dźwiga żadnej rotacji zależnej od sterowania.
